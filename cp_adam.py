...
model = cp(size, rank, beta=0.2, d=1)#,  beta = 1, c = 1)#5, 1e4) # beta=0.2, c=10)
model.to(device)
...
#        loss_train += loss.item()
    ...
    print('Epoch {} training loss {:4.4f} testing loss {:4.4f} tau {:4.4f}'.format(
            epoch, loss_train, loss_test, model.tau.item()))
