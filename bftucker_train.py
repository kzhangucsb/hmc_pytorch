"""
Created on Fri Sep 13 14:23:29 2019
...
#from cp import cp
from bfcp import bftucker, regulized_loss
...
model = bftucker(size, rank, beta=1, d=1e4)#1, beta = 1, c = 1)#5, 1e4) # beta=0.2, c=10)
...
plt.legend()
plt.show()
with open('../models/tucker_bayes_model_{}.pth'.format(nl), 'wb') as f:
